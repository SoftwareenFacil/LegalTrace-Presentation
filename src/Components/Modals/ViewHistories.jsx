...
import Copiar from "../../Assets/Icons/Copiar.svg?react";
...
function ViewHistories({
  ...
  return (
    <>
      <Modal className="view-history" show={show} onHide={onClose} size="lg">
        <Modal.Header className="view-header">
          <Modal.Title className="view-header-box">
            ...
            <div>
              ...
              <small className="view-header-client">
                en "{data.clientName}"
              </small>
            </div>
          </Modal.Title>
        ...
        <Modal.Body className="view-body">
          <div className="view-buttons">
            <div className="d-flex justify-content-end div-desactivar">
              {data.vigency ? (
                <Button
                  className="view-desactivar-button"
                  variant="primary"
          ...
          <div className="view-text-box" contentEditable="false">
            {data.description}
          </div>

          <div className="view-buttons">
            <div className="mt-3 d-flex justify-content-between">
              <Button className="view-editar-button" onClick={handleEditShow}>
                <Editar className="icon" />
                Editar
              </Button>
              <Button
                className="view-copiar-button"
          ...
          {copied && (
            <div className="alert alert-success mt-2">{Mensajes.Copiado}</div>
          )}
        </Modal.Body>
      </Modal>
      <CustomModal
